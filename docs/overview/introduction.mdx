...
- [Alert lifecycle](/overview/onboarding): Table of reserved-code lifecycles (view with correlation → incident → workflow flow, edit, pause, delete) plus a repeatable onboard wizard.
- [Approvals](/overview/approvals): Opt-in second-person review for maintenance, workflow runs, deletes, Temporal HITL, and webhooks.
