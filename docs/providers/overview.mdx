...
<Card
  title="Chronosphere"
  href="/providers/documentation/chronosphere-provider"
  icon={
    <img src="https://img.logo.dev/chronosphere.io?token=pk_dfXfZBoKQMGDTIgqu7LvYg" />
  }
></Card>
...
<Card
  title="Temporal"
  href="/providers/documentation/temporal-provider"
  icon={
    <img src="https://img.logo.dev/temporal.io?token=pk_dfXfZBoKQMGDTIgqu7LvYg" />
  }
></Card>
