...
Lists workflows associated with the incident, showing actions taken or available options for resolution. From this tab you can also **register a Temporal workflow** from the [Temporal workflow catalog](/overview/temporal-workflow-catalog) (Catalog → Temporal workflow in the sidebar).
